    ...
    <v-card flat>
      <v-container>
        <v-form ref="form" lazy-validation>
          ...
          <v-select v-model="city_id" v-if="province_id>0" :items="citiesByProvince" item-text="city_name" item-value="id" label="City" persistent-hint single-line></v-select>
        </v-form>
        <v-card-actions>
        ...
        <div>
          <v-card flat>
            <v-container>
              ...
              <v-select v-model="service" v-if="courier" :items="services['service']" @change="calculateBill" item-text="resume" item-value="service" label="Courier Service" persistent-hint single-line></v-select>
              <v-card-actions>
                Subtotal
                <v-spacer />
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      // tambahkan ini untuk Menampilkan Cart Pada Component Checkout
      carts: 'cart/carts',
      countCart: 'cart/count',
      totalPrice: 'cart/totalPrice',
      totalQuantity: 'cart/totalQuantity',
      totalWeight: 'cart/totalWeight',
      couriers: 'cart/couriers',
  ...
  methods: {
    ...mapActions({
      ...
      totalWeight: 'cart/totalWeight',
      setCart: 'cart/set',
      setCouriers: 'cart/setCouriers',
      setServices: 'cart/setServices',
  ...
  created() {
    ...
    .then((response) => {
      this.setCouriers(response.data.data)
    })
